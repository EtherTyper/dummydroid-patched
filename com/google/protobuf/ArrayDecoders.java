...
final class ArrayDecoders {
   ...
   static int decodeExtensionOrUnknownField(int tag, byte[] data, int position, int limit, Object message, MessageLite defaultInstance, UnknownFieldSchema unknownFieldSchema, ArrayDecoders.Registers registers) throws IOException {
      int number = tag >>> 3;
   ...
   static int decodeExtension(int tag, byte[] data, int position, int limit, GeneratedMessageLite.ExtendableMessage message, GeneratedMessageLite.GeneratedExtension extension, UnknownFieldSchema unknownFieldSchema, ArrayDecoders.Registers registers) throws IOException {
      FieldSet extensions = message.extensions;
