...
final class SchemaUtil {
   ...
   static void mergeUnknownFields(UnknownFieldSchema schema, Object message, Object other) {
      Object messageUnknowns = schema.getFromMessage(message);
      Object otherUnknowns = schema.getFromMessage(other);
      Object merged = schema.merge(messageUnknowns, otherUnknowns);
      schema.setToMessage(message, merged);
   }

   static Object filterUnknownEnumList(int number, List enumList, Internal.EnumLiteMap enumMap, Object unknownFields, UnknownFieldSchema unknownFieldSchema) {
      if (enumMap == null) {
   ...
   static Object filterUnknownEnumList(int number, List enumList, Internal.EnumVerifier enumVerifier, Object unknownFields, UnknownFieldSchema unknownFieldSchema) {
   ...
   static Object storeUnknownEnum(int number, int enumValue, Object unknownFields, UnknownFieldSchema unknownFieldSchema) {
