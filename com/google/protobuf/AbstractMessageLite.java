...
public abstract class AbstractMessageLite implements MessageLite {
   ...
   /** @deprecated */
   @Deprecated
   protected static void addAll(Iterable values, Collection list) {
      AbstractMessageLite.Builder.addAll(values, (List)list);
   }

   protected static void addAll(Iterable values, List list) {
   ...
   public abstract static class Builder implements MessageLite.Builder {
      ...
      public AbstractMessageLite.Builder mergeFrom(CodedInputStream input) throws IOException {
      ...
      public AbstractMessageLite.Builder mergeFrom(ByteString data) throws InvalidProtocolBufferException {
         try {
      ...
      public AbstractMessageLite.Builder mergeFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         try {
            CodedInputStream input = data.newCodedInput();
      ...
      public AbstractMessageLite.Builder mergeFrom(byte[] data) throws InvalidProtocolBufferException {
         return this.mergeFrom(data, 0, data.length);
      }

      public AbstractMessageLite.Builder mergeFrom(byte[] data, int off, int len) throws InvalidProtocolBufferException {
         try {
      ...
      public AbstractMessageLite.Builder mergeFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return this.mergeFrom(data, 0, data.length, extensionRegistry);
      }

      public AbstractMessageLite.Builder mergeFrom(byte[] data, int off, int len, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         try {
            CodedInputStream input = CodedInputStream.newInstance(data, off, len);
            this.mergeFrom(input, extensionRegistry);
            input.checkLastTagWas(0);
      ...
      public AbstractMessageLite.Builder mergeFrom(InputStream input) throws IOException {
      ...
      public AbstractMessageLite.Builder mergeFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         CodedInputStream codedInput = CodedInputStream.newInstance(input);
