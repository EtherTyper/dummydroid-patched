...
public abstract class AbstractMessage extends AbstractMessageLite implements Message {
   ...
   public abstract static class Builder extends AbstractMessageLite.Builder implements Message.Builder {
      ...
      public AbstractMessage.Builder clearOneof(Descriptors.OneofDescriptor oneof) {
      ...
      protected AbstractMessage.Builder internalMergeFrom(AbstractMessageLite other) {
         return this.mergeFrom((Message)other);
      }

      public AbstractMessage.Builder mergeFrom(Message other) {
         return this.mergeFrom(other, other.getAllFields());
      }

      AbstractMessage.Builder mergeFrom(Message other, Map allFields) {
      ...
      public AbstractMessage.Builder mergeFrom(CodedInputStream input) throws IOException {
         return this.mergeFrom((CodedInputStream)input, (ExtensionRegistryLite)ExtensionRegistry.getEmptyRegistry());
      }

      public AbstractMessage.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public AbstractMessage.Builder mergeUnknownFields(UnknownFieldSet unknownFields) {
      ...
      public AbstractMessage.Builder mergeFrom(ByteString data) throws InvalidProtocolBufferException {
         return (AbstractMessage.Builder)super.mergeFrom(data);
      }

      public AbstractMessage.Builder mergeFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return (AbstractMessage.Builder)super.mergeFrom(data, extensionRegistry);
      }

      public AbstractMessage.Builder mergeFrom(byte[] data) throws InvalidProtocolBufferException {
         return (AbstractMessage.Builder)super.mergeFrom(data);
      }

      public AbstractMessage.Builder mergeFrom(byte[] data, int off, int len) throws InvalidProtocolBufferException {
         return (AbstractMessage.Builder)super.mergeFrom(data, off, len);
      }

      public AbstractMessage.Builder mergeFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return (AbstractMessage.Builder)super.mergeFrom(data, extensionRegistry);
      }

      public AbstractMessage.Builder mergeFrom(byte[] data, int off, int len, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return (AbstractMessage.Builder)super.mergeFrom(data, off, len, extensionRegistry);
      }

      public AbstractMessage.Builder mergeFrom(InputStream input) throws IOException {
         return (AbstractMessage.Builder)super.mergeFrom(input);
      }

      public AbstractMessage.Builder mergeFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return (AbstractMessage.Builder)super.mergeFrom(input, extensionRegistry);
      }
