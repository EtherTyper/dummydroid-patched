...
public final class Descriptors {
   ...
   public static final class OneofDescriptor extends Descriptors.GenericDescriptor {
      ...
      // $FF: synthetic method
      OneofDescriptor(DescriptorProtos.OneofDescriptorProto x0, Descriptors.FileDescriptor x1, Descriptors.Descriptor x2, int x3, Object x4) throws Descriptors.DescriptorValidationException {
         this(x0, x1, x2, x3);
      }
   }
   ...
   private static final class DescriptorPool {
      ...
      DescriptorPool(Descriptors.FileDescriptor[] dependencies, boolean allowUnknownDependencies) {
         ...
         while(var7.hasNext()) {
            Descriptors.FileDescriptor dependency = (Descriptors.FileDescriptor)var7.next();
         ...
         if (result == null || filter != Descriptors.DescriptorPool.SearchFilter.ALL_SYMBOLS && (filter != Descriptors.DescriptorPool.SearchFilter.TYPES_ONLY || !this.isType(result)) && (filter != Descriptors.DescriptorPool.SearchFilter.AGGREGATES_ONLY || !this.isAggregate(result))) {
            ...
            do {
               do {
                  ...
                  Descriptors.FileDescriptor dependency = (Descriptors.FileDescriptor)var4.next();
      ...
      boolean isAggregate(Descriptors.GenericDescriptor descriptor) {
         return descriptor instanceof Descriptors.Descriptor || descriptor instanceof Descriptors.EnumDescriptor || descriptor instanceof Descriptors.DescriptorPool.PackageDescriptor || descriptor instanceof Descriptors.ServiceDescriptor;
      }
      ...
      Descriptors.GenericDescriptor lookupSymbol(String name, Descriptors.GenericDescriptor relativeTo, Descriptors.DescriptorPool.SearchFilter filter) throws Descriptors.DescriptorValidationException {
         ...
         if (result == null) {
            if (this.allowUnknownDependencies && filter == Descriptors.DescriptorPool.SearchFilter.TYPES_ONLY) {
               ...
               Descriptors.GenericDescriptor result = new Descriptors.Descriptor(fullname);
         ...
         if (old != null) {
            ...
            if (descriptor.getFile() == old.getFile()) {
               ...
               if (dotpos == -1) {
                  ...
                  throw new Descriptors.DescriptorValidationException(descriptor, '"' + fullName.substring(dotpos + 1) + "\" is already defined in \"" + fullName.substring(0, dotpos) + "\".");
               }
            } else {
               throw new Descriptors.DescriptorValidationException(descriptor, '"' + fullName + "\" is already defined in file \"" + old.getFile().getName() + "\".");
            }
         }
      }
      ...
      void addPackage(String fullName, Descriptors.FileDescriptor file) throws Descriptors.DescriptorValidationException {
         ...
         Descriptors.GenericDescriptor old = (Descriptors.GenericDescriptor)this.descriptorsByName.put(fullName, new Descriptors.DescriptorPool.PackageDescriptor(name, fullName, file));
         if (old != null) {
            this.descriptorsByName.put(fullName, old);
            if (!(old instanceof Descriptors.DescriptorPool.PackageDescriptor)) {
               throw new Descriptors.DescriptorValidationException(file, '"' + name + "\" is already defined (as something other than a package) in file \"" + old.getFile().getName() + "\".");
            }
         }
      ...
      void addFieldByNumber(Descriptors.FieldDescriptor field) throws Descriptors.DescriptorValidationException {
         Descriptors.DescriptorPool.DescriptorIntPair key = new Descriptors.DescriptorPool.DescriptorIntPair(field.getContainingType(), field.getNumber());
         ...
         if (old != null) {
            ...
            throw new Descriptors.DescriptorValidationException(field, "Field number " + field.getNumber() + " has already been used in \"" + field.getContainingType().getFullName() + "\" by field \"" + old.getName() + "\".");
         }
      }

      void addEnumValueByNumber(Descriptors.EnumValueDescriptor value) {
         Descriptors.DescriptorPool.DescriptorIntPair key = new Descriptors.DescriptorPool.DescriptorIntPair(value.getType(), value.getNumber());
      ...
      private static final class DescriptorIntPair {
         ...
         public boolean equals(Object obj) {
            if (!(obj instanceof Descriptors.DescriptorPool.DescriptorIntPair)) {
               ...
               Descriptors.DescriptorPool.DescriptorIntPair other = (Descriptors.DescriptorPool.DescriptorIntPair)obj;
   ...
   public static class DescriptorValidationException extends Exception {
      ...
      // $FF: synthetic method
      DescriptorValidationException(Descriptors.FileDescriptor x0, String x1, Object x2) {
         this(x0, x1);
      }

      // $FF: synthetic method
      DescriptorValidationException(Descriptors.GenericDescriptor x0, String x1, Object x2) {
         this(x0, x1);
      }

      // $FF: synthetic method
      DescriptorValidationException(Descriptors.GenericDescriptor x0, String x1, Throwable x2, Object x3) {
         this(x0, x1, x2);
      }
   }
   ...
   public static final class MethodDescriptor extends Descriptors.GenericDescriptor {
      ...
      private void crossLink() throws Descriptors.DescriptorValidationException {
         Descriptors.GenericDescriptor input = this.file.pool.lookupSymbol(this.proto.getInputType(), this, Descriptors.DescriptorPool.SearchFilter.TYPES_ONLY);
         if (!(input instanceof Descriptors.Descriptor)) {
            ...
            Descriptors.GenericDescriptor output = this.file.pool.lookupSymbol(this.proto.getOutputType(), this, Descriptors.DescriptorPool.SearchFilter.TYPES_ONLY);
      ...
      // $FF: synthetic method
      MethodDescriptor(DescriptorProtos.MethodDescriptorProto x0, Descriptors.FileDescriptor x1, Descriptors.ServiceDescriptor x2, int x3, Object x4) throws Descriptors.DescriptorValidationException {
         this(x0, x1, x2, x3);
      }
   }
   ...
   public static final class ServiceDescriptor extends Descriptors.GenericDescriptor {
      ...
      public Descriptors.MethodDescriptor findMethodByName(String name) {
         ...
         return result != null && result instanceof Descriptors.MethodDescriptor ? (Descriptors.MethodDescriptor)result : null;
      }
      ...
      private ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto proto, Descriptors.FileDescriptor file, int index) throws Descriptors.DescriptorValidationException {
         ...
         this.index = index;
         this.proto = proto;
         this.fullName = Descriptors.computeFullName(file, (Descriptors.Descriptor)null, proto.getName());
         this.file = file;
      ...
      private void crossLink() throws Descriptors.DescriptorValidationException {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            Descriptors.MethodDescriptor method = var1[var3];
            method.crossLink();
         }
      ...
      // $FF: synthetic method
      ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto x0, Descriptors.FileDescriptor x1, int x2, Object x3) throws Descriptors.DescriptorValidationException {
         this(x0, x1, x2);
      }
   }
   ...
   public static final class EnumValueDescriptor extends Descriptors.GenericDescriptor implements Internal.EnumLite {
      ...
      // $FF: synthetic method
      EnumValueDescriptor(Descriptors.FileDescriptor x0, Descriptors.EnumDescriptor x1, Integer x2, Object x3) {
         this(x0, x1, x2);
      }

      // $FF: synthetic method
      EnumValueDescriptor(DescriptorProtos.EnumValueDescriptorProto x0, Descriptors.FileDescriptor x1, Descriptors.EnumDescriptor x2, int x3, Object x4) throws Descriptors.DescriptorValidationException {
         this(x0, x1, x2, x3);
      }
   }
   ...
   public static final class EnumDescriptor extends Descriptors.GenericDescriptor implements Internal.EnumLiteMap {
      ...
      public Descriptors.EnumValueDescriptor findValueByName(String name) {
         Descriptors.GenericDescriptor result = this.file.pool.findSymbol(this.fullName + '.' + name);
         return result != null && result instanceof Descriptors.EnumValueDescriptor ? (Descriptors.EnumValueDescriptor)result : null;
      }

      public Descriptors.EnumValueDescriptor findValueByNumber(int number) {
         return (Descriptors.EnumValueDescriptor)this.file.pool.enumValuesByNumber.get(new Descriptors.DescriptorPool.DescriptorIntPair(this, number));
      }
      ...
      public Descriptors.EnumValueDescriptor findValueByNumberCreatingIfUnknown(int number) {
         ...
         if (result != null) {
            ...
            synchronized(this) {
               ...
               WeakReference reference = (WeakReference)this.unknownValues.get(key);
               if (reference != null) {
                  result = (Descriptors.EnumValueDescriptor)reference.get();
               }

               if (result == null) {
                  result = new Descriptors.EnumValueDescriptor(this.file, this, key);
      ...
      // $FF: synthetic method
      EnumDescriptor(DescriptorProtos.EnumDescriptorProto x0, Descriptors.FileDescriptor x1, Descriptors.Descriptor x2, int x3, Object x4) throws Descriptors.DescriptorValidationException {
         this(x0, x1, x2, x3);
      }
   }
   ...
   public static final class FieldDescriptor extends Descriptors.GenericDescriptor implements Comparable, FieldSet.FieldDescriptorLite {
      ...
      private void crossLink() throws Descriptors.DescriptorValidationException {
         Descriptors.GenericDescriptor typeDescriptor;
         if (this.proto.hasExtendee()) {
            ...
            this.containingType = (Descriptors.Descriptor)typeDescriptor;
      ...
      // $FF: synthetic method
      FieldDescriptor(DescriptorProtos.FieldDescriptorProto x0, Descriptors.FileDescriptor x1, Descriptors.Descriptor x2, int x3, boolean x4, Object x5) throws Descriptors.DescriptorValidationException {
         this(x0, x1, x2, x3, x4);
      }
   ...
   public static final class Descriptor extends Descriptors.GenericDescriptor {
      ...
      public Descriptors.FieldDescriptor findFieldByName(String name) {
         Descriptors.GenericDescriptor result = this.file.pool.findSymbol(this.fullName + '.' + name);
         return result != null && result instanceof Descriptors.FieldDescriptor ? (Descriptors.FieldDescriptor)result : null;
      }

      public Descriptors.FieldDescriptor findFieldByNumber(int number) {
         return (Descriptors.FieldDescriptor)this.file.pool.fieldsByNumber.get(new Descriptors.DescriptorPool.DescriptorIntPair(this, number));
      }

      public Descriptors.Descriptor findNestedTypeByName(String name) {
         Descriptors.GenericDescriptor result = this.file.pool.findSymbol(this.fullName + '.' + name);
         return result != null && result instanceof Descriptors.Descriptor ? (Descriptors.Descriptor)result : null;
      }

      public Descriptors.EnumDescriptor findEnumTypeByName(String name) {
         Descriptors.GenericDescriptor result = this.file.pool.findSymbol(this.fullName + '.' + name);
         return result != null && result instanceof Descriptors.EnumDescriptor ? (Descriptors.EnumDescriptor)result : null;
      }
      ...
      private void crossLink() throws Descriptors.DescriptorValidationException {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            Descriptors.Descriptor nestedType = var1[var3];
      ...
      // $FF: synthetic method
      Descriptor(DescriptorProtos.DescriptorProto x0, Descriptors.FileDescriptor x1, Descriptors.Descriptor x2, int x3, Object x4) throws Descriptors.DescriptorValidationException {
         this(x0, x1, x2, x3);
      }
   }
   ...
   public static final class FileDescriptor extends Descriptors.GenericDescriptor {
      ...
      public Descriptors.Descriptor findMessageTypeByName(String name) {
         if (name.indexOf(46) != -1) {
            ...
            return result != null && result instanceof Descriptors.Descriptor && result.getFile() == this ? (Descriptors.Descriptor)result : null;
         }
      }
      ...
      public Descriptors.EnumDescriptor findEnumTypeByName(String name) {
         if (name.indexOf(46) != -1) {
            ...
            Descriptors.GenericDescriptor result = this.pool.findSymbol(name);
            return result != null && result instanceof Descriptors.EnumDescriptor && result.getFile() == this ? (Descriptors.EnumDescriptor)result : null;
         }
      }
      ...
      public Descriptors.ServiceDescriptor findServiceByName(String name) {
         if (name.indexOf(46) != -1) {
            ...
            Descriptors.GenericDescriptor result = this.pool.findSymbol(name);
            return result != null && result instanceof Descriptors.ServiceDescriptor && result.getFile() == this ? (Descriptors.ServiceDescriptor)result : null;
         }
      }
      ...
      public Descriptors.FieldDescriptor findExtensionByName(String name) {
         if (name.indexOf(46) != -1) {
            ...
            Descriptors.GenericDescriptor result = this.pool.findSymbol(name);
            return result != null && result instanceof Descriptors.FieldDescriptor && result.getFile() == this ? (Descriptors.FieldDescriptor)result : null;
         }
      }
      ...
      private static Descriptors.FileDescriptor[] findDescriptors(Class descriptorOuterClass, String[] dependencyClassNames, String[] dependencyFileNames) {
         ...
         for(int i = 0; i < dependencyClassNames.length; ++i) {
            try {
               ...
               descriptors.add((Descriptors.FileDescriptor)clazz.getField("descriptor").get((Object)null));
      ...
      private FileDescriptor(DescriptorProtos.FileDescriptorProto proto, Descriptors.FileDescriptor[] dependencies, Descriptors.DescriptorPool pool, boolean allowUnknownDependencies) throws Descriptors.DescriptorValidationException {
         ...
         Descriptors.FileDescriptor[] var6 = dependencies;
         int i = dependencies.length;

         int index;
         for(index = 0; index < i; ++index) {
            Descriptors.FileDescriptor file = var6[index];
         ...
         for(i = 0; i < proto.getMessageTypeCount(); ++i) {
            this.messageTypes[i] = new Descriptors.Descriptor(proto.getMessageType(i), this, (Descriptors.Descriptor)null, i);
         }

         this.enumTypes = new Descriptors.EnumDescriptor[proto.getEnumTypeCount()];

         for(i = 0; i < proto.getEnumTypeCount(); ++i) {
            this.enumTypes[i] = new Descriptors.EnumDescriptor(proto.getEnumType(i), this, (Descriptors.Descriptor)null, i);
         }
         ...
         for(i = 0; i < proto.getExtensionCount(); ++i) {
            this.extensions[i] = new Descriptors.FieldDescriptor(proto.getExtension(i), this, (Descriptors.Descriptor)null, i, true);
         }
      ...
      private void crossLink() throws Descriptors.DescriptorValidationException {
         ...
         int var3;
         for(var3 = 0; var3 < var2; ++var3) {
            Descriptors.Descriptor messageType = var1[var3];
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            Descriptors.ServiceDescriptor service = var5[var3];
            service.crossLink();
         }
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            Descriptors.FieldDescriptor extension = var6[var3];
            extension.crossLink();
         }
