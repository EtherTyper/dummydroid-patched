...
public class Base64G {
   ...
   public static byte[] decode(byte[] input, int offset, int len, int flags) {
      Base64G.Decoder decoder = new Base64G.Decoder(flags, new byte[len * 3 / 4]);
   ...
   public static byte[] encode(byte[] input, int offset, int len, int flags) {
      Base64G.Encoder encoder = new Base64G.Encoder(flags, (byte[])null);
   ...
   static class Encoder extends Base64G.Coder {
   ...
   static class Decoder extends Base64G.Coder {
