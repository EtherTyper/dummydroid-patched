...
public abstract class AbstractTlsKeyExchange implements TlsKeyExchange {
   ...
   protected AbstractTlsKeyExchange(int var1, Vector var2) {
      this.keyExchange = var1;
      this.supportedSignatureAlgorithms = var2;
   }

   protected void checkServerCertSigAlg(Certificate var1) throws IOException {
      if (this.supportedSignatureAlgorithms == null) {
      }

   }

   protected DigitallySigned parseSignature(InputStream var1) throws IOException {
