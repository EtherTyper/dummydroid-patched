...
public final class ProtocolVersion {
   ...
   public boolean isSSL() {
      return this.getFullVersion() == SSLv3.getFullVersion();
   }
   ...
   public ProtocolVersion getPreviousVersion() throws IOException {
      if (this.isDTLS()) {
         ...
         case 255:
            return null;
         default:
            return get(this.getMajorVersion(), this.getMinorVersion() + 1);
         }
      } else {
         switch(this.getMinorVersion()) {
         case 0:
   ...
   private static ProtocolVersion getUnknownVersion(int var0, int var1, String var2) throws IOException {
