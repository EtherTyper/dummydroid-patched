...
public class TlsClientProtocol extends TlsProtocol {
   ...
   public TlsClientProtocol(InputStream var1, OutputStream var2) {
      super(var1, var2);
   }
   ...
   public void connect(TlsClient var1) throws IOException {
      if (var1 == null) {
         ...
         this.tlsClientContext = new TlsClientContextImpl(var1.getCrypto(), this.securityParameters);
         this.securityParameters.clientRandom = createRandomBlock(var1.shouldUseGMTUnixTime(), this.tlsClientContext);
      ...
      if (this.resumedSession) {
         ...
         case 2:
            ...
            case 1:
               ...
               if (this.resumedSession) {
                  this.securityParameters.masterSecret = this.getContext().getCrypto().adoptSecret(this.sessionParameters.getMasterSecret());
                  this.recordStream.setPendingConnectionState(this.getPeer().getCompression(), this.getPeer().getCipher());
                  this.sendChangeCipherSpecMessage();
               } else {
                  this.invalidateSession();
                  this.tlsSession = TlsUtils.importSession(this.selectedSessionID, (SessionParameters)null);
         ...
         case 11:
            ...
            this.peerCertificate = Certificate.parse(this.getContext(), var2);
            assertEmpty(var2);
         ...
         case 14:
            ...
            case 7:
               ...
               TlsCredentialedSigner var5 = null;
               TlsStreamSigner var6 = null;
               if (this.certificateRequest == null) {
                  this.keyExchange.skipClientCredentials();
               } else {
                  var4 = validateCredentials(this.authentication.getClientCredentials(this.certificateRequest));
                  if (var4 == null) {
                     this.keyExchange.skipClientCredentials();
                     ...
                     if (var4 instanceof TlsCredentialedSigner) {
                        var5 = (TlsCredentialedSigner)var4;
                        var6 = var5.getStreamSigner();
                     }
                  }
               }
               ...
               TlsUtils.sealHandshakeHash(this.getContext(), this.recordStream.getHandshakeHash(), var7);
               ...
               TlsHandshakeHash var8 = this.recordStream.prepareToFinish();
               this.securityParameters.sessionHash = TlsUtils.getCurrentPRFHash(var8);
               if (!TlsUtils.isSSL(this.getContext())) {
                  establishMasterSecret(this.getContext(), this.keyExchange);
               }
               ...
               this.recordStream.setPendingConnectionState(this.getPeer().getCompression(), this.getPeer().getCipher());
               if (var5 != null) {
                  DigitallySigned var9 = TlsUtils.generateCertificateVerify(this.getContext(), var5, var6, var8);
                  this.sendCertificateVerifyMessage(var9);
