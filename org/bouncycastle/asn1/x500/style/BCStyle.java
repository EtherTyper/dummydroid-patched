   ...
   protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier var1, String var2) {
      if (!var1.equals(EmailAddress) && !var1.equals(DC)) {
         if (var1.equals(DATE_OF_BIRTH)) {
            ...
            return (ASN1Encodable)(!var1.equals(C) && !var1.equals(SN) && !var1.equals(DN_QUALIFIER) && !var1.equals(TELEPHONE_NUMBER) ? super.encodeStringValue(var1, var2) : new DERPrintableString(var2));
         }
      } else {
