...
public class TeleTrusTNamedCurves {
   static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         ...
         ECCurve var3 = TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16), new BigInteger("340E7BE2A280EB74E2BE61BADA745D97E8F7C300", 16), new BigInteger("1E589A8595423412134FAA2DBDEC95C8D8675E58", 16), var1, var2));
   ...
   static X9ECParametersHolder brainpoolP160t1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         BigInteger var1 = new BigInteger("E95E4A5F737059DC60DF5991D45029409E60FC09", 16);
         BigInteger var2 = new BigInteger("01", 16);
         ECCurve var3 = TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16), new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620C", 16), new BigInteger("7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380", 16), var1, var2));
   ...
   static X9ECParametersHolder brainpoolP192r1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         ...
         BigInteger var2 = new BigInteger("01", 16);
         ECCurve var3 = TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16), new BigInteger("6A91174076B1E0E19C39C031FE8685C1CAE040E5C69A28EF", 16), new BigInteger("469A28EF7C28CCA3DC721D044F4496BCCA7EF4146FBF25C9", 16), var1, var2));
   ...
   static X9ECParametersHolder brainpoolP192t1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         BigInteger var1 = new BigInteger("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1", 16);
         BigInteger var2 = new BigInteger("01", 16);
         ECCurve var3 = TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16), new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86294", 16), new BigInteger("13D56FFAEC78681E68F9DEB43B35BEC2FB68542E27897B79", 16), var1, var2));
         return new X9ECParameters(var3, new X9ECPoint(var3, Hex.decode("043AE9E58C82F63C30282E1FE7BBF43FA72C446AF6F4618129097E2C5667C2223A902AB5CA449D0084B7E5B3DE7CCC01C9")), var1, var2);
      }
   };
   static X9ECParametersHolder brainpoolP224r1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         ...
         BigInteger var2 = new BigInteger("01", 16);
         ECCurve var3 = TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(new BigInteger("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF", 16), new BigInteger("68A5E62CA9CE6C1C299803A6C1530B514E182AD8B0042A59CAD29F43", 16), new BigInteger("2580F63CCFE44138870713B1A92369E33E2135D266DBB372386C400B", 16), var1, var2));
   ...
   static X9ECParametersHolder brainpoolP224t1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         BigInteger var1 = new BigInteger("D7C134AA264366862A18302575D0FB98D116BC4B6DDEBCA3A5A7939F", 16);
         BigInteger var2 = new BigInteger("01", 16);
         ECCurve var3 = TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(new BigInteger("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF", 16), new BigInteger("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FC", 16), new BigInteger("4B337D934104CD7BEF271BF60CED1ED20DA14C08B3BB64F18A60888D", 16), var1, var2));
   ...
   static X9ECParametersHolder brainpoolP256r1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         ...
         BigInteger var2 = new BigInteger("01", 16);
         ECCurve var3 = TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(new BigInteger("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377", 16), new BigInteger("7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9", 16), new BigInteger("26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6", 16), var1, var2));
         return new X9ECParameters(var3, new X9ECPoint(var3, Hex.decode("048BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997")), var1, var2);
      }
   };
   ...
   static X9ECParametersHolder brainpoolP320t1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         ...
         return new X9ECParameters(var3, new X9ECPoint(var3, Hex.decode("04925BE9FB01AFC6FB4D3E7D4990010F813408AB106C4F09CB7EE07868CC136FFF3357F624A21BED5263BA3A7A27483EBF6671DBEF7ABB30EBEE084E58A0B077AD42A5A0989D1EE71B1B9BC0455FB0D2C3")), var1, var2);
      }
   };
   static X9ECParametersHolder brainpoolP384r1 = new X9ECParametersHolder() {
      protected X9ECParameters createParameters() {
         ...
         BigInteger var2 = new BigInteger("01", 16);
         ECCurve var3 = TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(new BigInteger("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53", 16), new BigInteger("7BC382C63D8C150C3C72080ACE05AFA0C2BEA28E4FB22787139165EFBA91F90F8AA5814A503AD4EB04A8C7DD22CE2826", 16), new BigInteger("4A8C7DD22CE28268B39B55416F0447C2FB77DE107DCD2A62E880EA53EEB62D57CB4390295DBC9943AB78696FA504C11", 16), var1, var2));
         return new X9ECParameters(var3, new X9ECPoint(var3, Hex.decode("041D1C64F068CF45FFA2A63A81B7C13F6B8847A3E77EF14FE3DB7FCAFE0CBD10E8E826E03436D646AAEF87B2E247D4AF1E8ABE1D7520F9C2A45CB1EB8E95CFD55262B70B29FEEC5864E19C054FF99129280E4646217791811142820341263C5315")), var1, var2);
      }
   };
   ...
   public static X9ECParameters getByName(String var0) {
      ASN1ObjectIdentifier var1 = (ASN1ObjectIdentifier)objIds.get(Strings.toLowerCase(var0));
