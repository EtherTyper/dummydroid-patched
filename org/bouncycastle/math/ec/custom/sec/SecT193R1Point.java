...
public class SecT193R1Point extends ECPoint.AbstractF2m {
   /** @deprecated */
   public SecT193R1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3) {
      this(var1, var2, var3, false);
   }

   /** @deprecated */
   public SecT193R1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3, boolean var4) {
   ...
   SecT193R1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3, ECFieldElement[] var4, boolean var5) {
         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var17.isZero()) {
                     return new SecT193R1Point(var2, var17, var2.getB().sqrt(), this.withCompression);
                  }
               ...
               return new SecT193R1Point(var2, var17, var18, new ECFieldElement[]{var19}, this.withCompression);
            }
         }
      }
   }
   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            if (var10.isZero()) {
               return new SecT193R1Point(var1, var10, var1.getB().sqrt(), this.withCompression);
            } else {
               ...
               return new SecT193R1Point(var1, var11, var14, new ECFieldElement[]{var12}, this.withCompression);
            }
         }
      }
   }
         ...
         if (var3.isZero()) {
            ...
            if (!var4.isZero() && var5.isOne()) {
               ...
               if (var17.isZero()) {
                  ...
                  return new SecT193R1Point(var2, var15, var2.getB().sqrt(), this.withCompression);
               } else {
                  ...
                  return new SecT193R1Point(var2, var18, var20, new ECFieldElement[]{var19}, this.withCompression);
               }
            } else {
   ...
   public ECPoint negate() {
      if (this.isInfinity()) {
         ...
         if (var1.isZero()) {
            ...
            return new SecT193R1Point(this.curve, var1, var2.add(var3), new ECFieldElement[]{var3}, this.withCompression);
         }
      }
   }
}
