         ...
         if (var3.isZero()) {
            ...
            if (Nat576.isZero64(var12)) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var21.isZero()) {
                     return new SecT571K1Point(var2, var21, var2.getB(), this.withCompression);
                  }
               ...
               return new SecT571K1Point(var2, var21, var22, new ECFieldElement[]{var23}, this.withCompression);
            }
         }
      }
   }
