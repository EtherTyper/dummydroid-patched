...
public class SecT163K1Point extends ECPoint.AbstractF2m {
   /** @deprecated */
   public SecT163K1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3) {
      this(var1, var2, var3, false);
   }

   /** @deprecated */
   public SecT163K1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3, boolean var4) {
   ...
   SecT163K1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3, ECFieldElement[] var4, boolean var5) {
         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var17.isZero()) {
                     return new SecT163K1Point(var2, var17, var2.getB(), this.withCompression);
                  }
               ...
               return new SecT163K1Point(var2, var17, var18, new ECFieldElement[]{var19}, this.withCompression);
            }
         }
      }
   }
   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            if (var8.isZero()) {
               return new SecT163K1Point(var1, var8, var1.getB(), this.withCompression);
            } else {
               ...
               return new SecT163K1Point(var1, var9, var12, new ECFieldElement[]{var10}, this.withCompression);
            }
         }
      }
   }
         ...
         if (var3.isZero()) {
            ...
            if (!var4.isZero() && var5.isOne()) {
               ...
               if (var16.isZero()) {
                  ...
                  return new SecT163K1Point(var2, var14, var2.getB(), this.withCompression);
               } else {
                  ...
                  return new SecT163K1Point(var2, var17, var19, new ECFieldElement[]{var18}, this.withCompression);
               }
            } else {
   ...
   public ECPoint negate() {
      if (this.isInfinity()) {
         ...
         if (var1.isZero()) {
            ...
            return new SecT163K1Point(this.curve, var1, var2.add(var3), new ECFieldElement[]{var3}, this.withCompression);
         }
      }
   }
}
