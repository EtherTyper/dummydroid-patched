         ...
         if (var3.isZero()) {
            ...
            if (Nat576.isZero64(var12)) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var21.isZero()) {
                     return new SecT571R1Point(var2, var21, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
                  }
                  ...
                  SecT571Field.multiplyPrecomp(var12, var29, var23.x);
                  if (var16 != null) {
                  ...
                  SecT571Field.multiplyAddToExt(var12, var23.x, var30);
                  var22 = new SecT571FieldElement(var12);
                  SecT571Field.reduce(var30, var22.x);
                  if (var13 != null) {
                     SecT571Field.multiplyPrecomp(var23.x, var13, var23.x);
                  }
               }

               return new SecT571R1Point(var2, var21, var22, new ECFieldElement[]{var23}, this.withCompression);
            }
         }
      }
   }
