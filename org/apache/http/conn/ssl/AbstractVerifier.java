...
public abstract class AbstractVerifier implements X509HostnameVerifier {
   ...
   public final void verify(String host, X509Certificate cert) throws SSLException {
      List allSubjectAltNames = DefaultHostnameVerifier.getSubjectAltNames(cert);
      List subjectAlts = new ArrayList();
      Iterator i$;
   ...
   public final void verify(String host, String[] cns, String[] subjectAlts, boolean strictWithSubDomains) throws SSLException {
      ...
      List subjectAltList = subjectAlts != null && subjectAlts.length > 0 ? Arrays.asList(subjectAlts) : null;
   ...
   public static String[] getDNSSubjectAlts(X509Certificate cert) {
      List subjectAltNames = DefaultHostnameVerifier.getSubjectAltNames(cert);
      if (subjectAltNames == null) {
         return null;
      } else {
         List dnsAlts = new ArrayList();
