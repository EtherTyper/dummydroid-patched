...
public final class DefaultHostnameVerifier implements HostnameVerifier {
   ...
   public void verify(String host, X509Certificate cert) throws SSLException {
      DefaultHostnameVerifier.HostNameType hostType = determineHostFormat(host);
      List subjectAlts = getSubjectAltNames(cert);
   ...
   static DefaultHostnameVerifier.HostNameType determineHostFormat(String host) {
   ...
   static List getSubjectAltNames(X509Certificate cert) {
      try {
         Collection entries = cert.getSubjectAlternativeNames();
         if (entries == null) {
