...
public final class PublicSuffixMatcherLoader {
   ...
   private static PublicSuffixMatcher load(InputStream in) throws IOException {
      List lists = (new PublicSuffixListParser()).parseByType(new InputStreamReader(in, Consts.UTF_8));
         ...
         synchronized(PublicSuffixMatcherLoader.class) {
            if (DEFAULT_INSTANCE == null) {
               ...
               if (url != null) {
                  ...
                  DEFAULT_INSTANCE = new PublicSuffixMatcher(Arrays.asList("com"), (Collection)null);
               }
            }
         }
      }
