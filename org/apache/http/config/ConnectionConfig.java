...
public class ConnectionConfig implements Cloneable {
   ...
   public static ConnectionConfig.Builder copy(ConnectionConfig config) {
      ...
      return (new ConnectionConfig.Builder()).setBufferSize(config.getBufferSize()).setCharset(config.getCharset()).setFragmentSizeHint(config.getFragmentSizeHint()).setMalformedInputAction(config.getMalformedInputAction()).setUnmappableInputAction(config.getUnmappableInputAction()).setMessageConstraints(config.getMessageConstraints());
   }
