...
public class HttpRequestWrapper extends AbstractHttpMessage implements HttpUriRequest {
   ...
   public static HttpRequestWrapper wrap(HttpRequest request, HttpHost target) {
      ...
      return (HttpRequestWrapper)(request instanceof HttpEntityEnclosingRequest ? new HttpRequestWrapper.HttpEntityEnclosingRequestWrapper((HttpEntityEnclosingRequest)request, target) : new HttpRequestWrapper(request, target));
   }
